...
def computeControl(x):
    negative_k= np.array([[17.32050808 ,13.65819229 , -8.86673818 , -54.67483175]])
    matrix_mult= np.subtract(x,goal)
    control = np.matmul(negative_k,matrix_mult) # This means apply no force. Please replace this with your computations and 
